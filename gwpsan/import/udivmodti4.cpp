...
SAN_UNUSED
inline du_int udiv128by64to64default(du_int u1, du_int u0, du_int v,
                                     du_int* r) {
  const unsigned n_udword_bits = sizeof(du_int) * kByteBits;
...
inline du_int udiv128by64to64(du_int u1, du_int u0, du_int v, du_int* r) {
...
extern "C" {
SAN_LOCAL SAN_USED tu_int gwpsan_udivmodti4(tu_int a, tu_int b, tu_int* rem) {
  const unsigned n_utword_bits = sizeof(tu_int) * kByteBits;
  utwords dividend;
  dividend.all = a;
  utwords divisor;
  divisor.all = b;
