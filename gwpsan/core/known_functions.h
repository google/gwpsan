...
#ifndef THIRD_PARTY_GWP_SANITIZERS_CORE_KNOWN_FUNCTIONS_H_
#define THIRD_PARTY_GWP_SANITIZERS_CORE_KNOWN_FUNCTIONS_H_
...
#endif  // THIRD_PARTY_GWP_SANITIZERS_CORE_KNOWN_FUNCTIONS_H_
