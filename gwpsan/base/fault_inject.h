...
#ifndef THIRD_PARTY_GWP_SANITIZERS_BASE_FAULT_INJECT_H_
#define THIRD_PARTY_GWP_SANITIZERS_BASE_FAULT_INJECT_H_
...
#endif  // THIRD_PARTY_GWP_SANITIZERS_BASE_FAULT_INJECT_H_
